	...
	for (int i = 0; i < pManager->getComponentCount(); i++)
	{
		...
		if (pComp->getGraphicsinfo().x1 < x2 && pComp->getGraphicsinfo().x2 > x2 && pComp->getGraphicsinfo().y1 < y2 && pComp->getGraphicsinfo().y2 > y2)
		{
			if (((Gate*)pComp)->getInputPins() == 3) {
				if (y2 > pComp->getGraphicsinfo().y1 && y2 < pComp->getGraphicsinfo().y1 + (pComp->getGraphicsinfo().y2 - pComp->getGraphicsinfo().y1) / 3) {
					py2 = (pComp->getGraphicsinfo().y1 + 12);
					px2 = pComp->getGraphicsinfo().x1;
				}
				else if (y2 > pComp->getGraphicsinfo().y1 + (pComp->getGraphicsinfo().y2 - pComp->getGraphicsinfo().y1) / 3 && y2 < pComp->getGraphicsinfo().y2 - (pComp->getGraphicsinfo().y2 - pComp->getGraphicsinfo().y1) / 3) {
					py2 = (pComp->getGraphicsinfo().y1 + 24);
					px2 = pComp->getGraphicsinfo().x1;
				}
				else if (y2 > pComp->getGraphicsinfo().y2 - (pComp->getGraphicsinfo().y2 - pComp->getGraphicsinfo().y1) / 3 && y2 < pComp->getGraphicsinfo().y2) {
					py2 = (pComp->getGraphicsinfo().y1 + 36);
					px2 = pComp->getGraphicsinfo().x1;
				}
				else if (((Gate*)pComp)->getInputPins() == 2) {
					if (y2 > pComp->getGraphicsinfo().y1 && y2 < pComp->getGraphicsinfo().y1 + (pComp->getGraphicsinfo().y2 - pComp->getGraphicsinfo().y1) / 2) {
						py2 = (pComp->getGraphicsinfo().y1 + 12);
						px2 = (pComp->getGraphicsinfo().x1);
					}
					else if (y2 > pComp->getGraphicsinfo().y1 + (pComp->getGraphicsinfo().y2 - pComp->getGraphicsinfo().y1) / 2 && y2 < pComp->getGraphicsinfo().y2) {
						py2 = (pComp->getGraphicsinfo().y2 - 12);
						px2 = (pComp->getGraphicsinfo().x1);
					}
				}
				else if (((Gate*)pComp)->getInputPins() == 1) {
					py2 = (pComp->getGraphicsinfo().y2 - pComp->getGraphicsinfo().y1) / 2;
					px2 = (pComp->getGraphicsinfo().x1);
				}
				else {
